#!/usr/bin/env bash
set -e
echo "Creation des entites et repositories..."
mkdir -p src/Entity src/Repository

cat > src/Entity/Application.php <<'ENDOFPHP'
<?php
...
cat > src/Entity/Candidate.php <<'ENDOFPHP'
<?php
...
cat > src/Entity/Category.php <<'ENDOFPHP'
<?php
...
cat > src/Entity/Company.php <<'ENDOFPHP'
<?php
...
cat > src/Entity/JobOffer.php <<'ENDOFPHP'
<?php
...
cat > src/Entity/Message.php <<'ENDOFPHP'
<?php
...
cat > src/Entity/Notification.php <<'ENDOFPHP'
<?php
...
cat > src/Entity/Recruiter.php <<'ENDOFPHP'
<?php
...
cat > src/Entity/Resume.php <<'ENDOFPHP'
<?php
...
cat > src/Entity/Skill.php <<'ENDOFPHP'
<?php
...
cat > src/Entity/User.php <<'ENDOFPHP'
<?php
...
cat > src/Repository/ApplicationRepository.php <<'ENDOFPHP'
<?php
...
cat > src/Repository/CategoryRepository.php <<'ENDOFPHP'
<?php
...
cat > src/Repository/CompanyRepository.php <<'ENDOFPHP'
<?php
...
cat > src/Repository/JobOfferRepository.php <<'ENDOFPHP'
<?php
...
cat > src/Repository/UserRepository.php <<'ENDOFPHP'
<?php
...
echo "Termine : 11 entites + 5 repositories crees."
